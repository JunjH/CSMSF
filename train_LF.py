...
parser = argparse.ArgumentParser(description='training late fusion model for vision-lidar-thermal fusion')
...
parser.add_argument('--name', default='model_LF', type=str, help='name of experiment')
