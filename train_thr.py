...
parser = argparse.ArgumentParser(description='training on thermal')
...
parser.add_argument('--name', default='model_t', type=str, help='name of experiment')
